...
export class StandardSlots extends Slots{
    ...
    renderStandardSlots(){
        ...
        itemDiv.classList.add("standard-grid")
        ...
        let armorDiv = document.createElement("div")
            ...
            armorName.classList.add("equipment-slot-name")
            ...
            armorDescription.classList.add("equipment-slot-description")
            armorDiv.appendChild(armorDescription)
            armorDiv.classList.add("standard-slot")

        let mainHandDiv = document.createElement("div")

            let mainHandImg = document.createElement("img")
            mainHandImg.src = "Claymore.webp"
        ...
        let offHandDiv = document.createElement("div")
            ...
            offHandDiv.classList.add("standard-slot")
        let rangedDiv = document.createElement("div")
            let rangedImg = document.createElement("img")
            rangedImg.src = "Longbow.webp"
            rangedImg.classList.add("equipment-slot-image")
            rangedDiv.appendChild(rangedImg)
            ...
            rangedDiv.classList.add("standard-slot")

        let backpackDiv = document.createElement("div")
            let backpackImg = document.createElement("img")
            backpackImg.src = "Backpack.webp"
            backpackImg.classList.add("equipment-slot-image")
            backpackDiv.appendChild(backpackImg)
            //appends the armor name to the div
            ...
            backpackDiv.classList.add("standard-slot")

        //classlist to turn em into square boxes
        armorDiv.classList.add("armor-div")
        mainHandDiv.classList.add("mainhand-div")
        offHandDiv.classList.add("offhand-div")
        rangedDiv.classList.add("ranged-div")
        backpackDiv.classList.add("backpack-div")        
